...
class PaymentController extends Controller
{
    ...
    public function createCash()
    {
        ...
        // ✅ include approved public bookings + manual scheduled
        ...
        $appointments = Appointment::with(['patient', 'service'])
            ...
            ->whereNotNull('patient_id') // ✅ only approved bookings should reach payments
    ...
    public function storeCash(Request $request)
    {
        ...
        if ($request->appointment_id) {
            ...
            // ✅ extra guard: appointment must have patient (important for public bookings)
