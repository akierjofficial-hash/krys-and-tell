...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        // Overdue installments (right sidebar)
        ...
        try {
            ...
            foreach ($plans as $plan) {
                ...
                // expected monthly for months 2..n
                ...
                // find the FIRST unpaid overdue month
                for ($m = 1; $m <= $months; $m++) {
                    ...
                    if ($paid > 0) continue; // already paid
            ...
            // sort by most overdue first, take 5
            ...
            // If relationships/table differ, we just show empty gracefully
            $overdueInstallments = collect();
        }
    ...
    public function calendarEvents(Request $request)
    {
        ...
        // A) Appointments -> timeGrid events
        ...
        // B) Installment due dates -> allDay events (orange/red)
        try {
            ...
            foreach ($plans as $plan) {
                ...
                for ($m = 1; $m <= $months; $m++) {
                    ...
                    $events[] = [
                        ...
                        'extendedProps' => [
                            'type' => 'installment',
                            'url'  => url('/installments/' . $plan->id), // ✅ adjust if needed
                        ],
                    ];
                }
            }
        } catch (\Throwable $e) {
            // ignore if your tables/relations differ
        }
