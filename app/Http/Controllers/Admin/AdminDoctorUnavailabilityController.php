...
class AdminDoctorUnavailabilityController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('shared.dentist_unavailability.index', [
            ...
            'routePrefix' => 'admin.dentist-unavailability',
            'pageTitle' => 'Dentist Day-off',
            'pageSubtitle' => 'Admin can set, edit, and remove dentist unavailable dates. These dates are blocked in public booking.',
            'doctors' => $doctors,
            'items' => $items,
    ...
    public function store(Request $request)
    {
        ...
        return $this->ktRedirectToReturn($request, 'admin.dentist-unavailability.index')
