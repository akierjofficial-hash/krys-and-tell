...
<head>
    ...
    * {
    ...
    .kt-loader-bars span:nth-child(1) {
        animation-delay: 0s;
    }

    .kt-loader-bars span:nth-child(2) {
        animation-delay: .12s;
    }

    .kt-loader-bars span:nth-child(3) {
        animation-delay: .24s;
    }

    .kt-loader-bars span:nth-child(4) {
        animation-delay: .36s;
    }
        ...
        <div class="container py-2">
            <div class="d-flex flex-wrap flex-lg-nowrap align-items-center w-100">
                ...
                <div class="d-flex align-items-center gap-2 order-2 ms-auto order-lg-3">
                    ...
                    @auth
                    <div class="dropdown">
                        <button class="kt-avatar-btn" type="button" data-bs-toggle="dropdown" aria-expanded="false"
                        ...
                        <ul class="dropdown-menu dropdown-menu-end kt-dropdown">
                            ...
                            {{-- ✅ ADD: My Installment Plans (safe: won’t error if route not added yet) --}}
                            @if(\Illuminate\Support\Facades\Route::has('public.installments.index'))
                            <li>
                                <a class="dropdown-item" href="{{ route('public.installments.index') }}">
                                    <i class="fa-solid fa-receipt me-2"></i> My Installment Plans
                                </a>
                            </li>
                            @endif
                    ...
                    <a class="btn kt-btn kt-btn-outline d-inline-flex d-lg-none px-3" href="{{ route('userlogin') }}"
                        title="Sign in">
                        <i class="fa-solid fa-right-to-bracket"></i>
                    </a>

                    {{-- ✅ DESKTOP sign in button -> USERLOGIN (NOT /login) --}}
                    <a class="btn kt-btn kt-btn-outline d-none d-lg-inline-flex" href="{{ route('userlogin') }}">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-4">
                        <a href="{{ url('/') }}" class="kt-footer-brand d-inline-flex align-items-center gap-2">
                            <img class="kt-footer-logo" src="{{ asset('images/krysandtelllogo.jpg') }}"
                                alt="Krys & Tell logo">
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            <a class="kt-social" href="https://www.facebook.com/Ktelzaflats" aria-label="Facebook"><i
                                    class="fa-brands fa-facebook-f"></i></a>
                            <a class="kt-social" href="https://www.instagram.com/krysandtelldental/"
                                aria-label="Instagram"><i class="fa-brands fa-instagram"></i></a>
                            <a class="kt-social" href="https://www.tiktok.com/@krysandtell2023" aria-label="Tiktok"><i
                                    class="fa-brands fa-tiktok"></i></a>
                            <a class="kt-social" href="https://www.messenger.com/t/346771123068701"
                                aria-label="Messenger"><i class="fa-brands fa-facebook-messenger"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-6 col-lg-3">
                        ...
                        <ul class="kt-footer-links">
                            <li><a href="{{ url('/services') }}"><i class="fa-solid fa-tooth me-2"></i>General
                                    Dentistry</a></li>
                            <li><a href="{{ url('/services') }}"><i class="fa-solid fa-teeth me-2"></i>Orthodontics</a>
                            </li>
                            <li><a href="{{ url('/services') }}"><i class="fa-solid fa-face-smile me-2"></i>Cosmetic
                                    Dentistry</a></li>
                            <li><a href="{{ url('/services') }}"><i class="fa-solid fa-shield-heart me-2"></i>Cleaning &
                                    Prevention</a></li>
                        </ul>
                    </div>
                            ...
                            <div class="kt-info-item">
                                ...
                                <div>
                                    ...
                                    <div class="kt-info-sub">
                                        C-T Bldg. Jose Romero Rd Bagacay Dumaguete City, Negros Oriental (Across
                                        Hypermart)
                                    </div>
                                </div>
                            </div>
