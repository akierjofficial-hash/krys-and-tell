...
<div class="card-shell form-max">
    <div class="card-head">
        <div class="hint">Fields marked required must be filled in.</div>
        <div class="hint">You can add notes for internal use.</div>
    </div>

    <div class="card-bodyx">
        <form action="{{ route('staff.patients.store') }}" method="POST" id="patientForm">
            @csrf
            ...
            <div class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <textarea name="address" rows="2" class="textareax">{{ old('address') }}</textarea>
                </div>
