...
.sig-wrap {
    ...
    overflow: hidden;
    background: #fff;
    /* keep signature pad clear even in dark mode */
}
...
<div class="page-head">
    <div>
        ...
        <p class="subtitle">Patient fills this on iPad. Required fields are marked with <span
                class="text-danger">*</span>.</p>
    </div>

    <x-back-button fallback="{{ route('staff.patients.index') }}" class="btn-ghostx" label="Back to Patients" />
</div>
    ...
    <div class="list-group mb-3" style="border-radius:14px; overflow:hidden;">
        ...
        <div class="list-group-item d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-2">
                <a href="{{ route('staff.patients.show', $p->id) }}" class="btn btn-sm btn-outline-primary"
                    style="border-radius:10px;font-weight:800;">
                    View
                </a>
                <a href="{{ route('staff.patients.edit', $p->id) }}" class="btn btn-sm btn-outline-secondary"
                    style="border-radius:10px;font-weight:800;">
                    Edit
                </a>
            </div>
        ...
        <div class="card-bodyx">
            <div class="row g-3">
                ...
                <div class="col-12 col-md-4">
                    ...
                    <input type="text" name="contact_number" class="inputx" value="{{ old('contact_number') }}"
                        required>
            ...
            <div class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <div class="radio-row">
                        <label class="radio-pill"><input type="radio" name="good_health" value="1"
                                {{ old('good_health') === '1' ? 'checked' : '' }}> Yes</label>
                        <label class="radio-pill"><input type="radio" name="good_health" value="0"
                                {{ old('good_health') === '0' ? 'checked' : '' }}> No</label>
                    </div>
                </div>
                ...
                <div class="col-12">
                    ...
                    <div class="radio-row">
                        <label class="radio-pill"><input type="radio" name="under_treatment" value="1"
                                {{ old('under_treatment') === '1' ? 'checked' : '' }}> Yes</label>
                        <label class="radio-pill"><input type="radio" name="under_treatment" value="0"
                                {{ old('under_treatment') === '0' ? 'checked' : '' }}> No</label>
                    </div>
                    <div class="mt-2">
                ...
                <div class="col-12">
                    ...
                    <div class="radio-row">
                        <label class="radio-pill"><input type="radio" name="serious_illness" value="1"
                                {{ old('serious_illness') === '1' ? 'checked' : '' }}> Yes</label>
                        <label class="radio-pill"><input type="radio" name="serious_illness" value="0"
                                {{ old('serious_illness') === '0' ? 'checked' : '' }}> No</label>
                    </div>
                    <div class="mt-2">
                        <textarea name="serious_illness_details" rows="2" class="textareax"
                            placeholder="If yes, please describe">{{ old('serious_illness_details') }}</textarea>
                    </div>
                </div>
                ...
                <div class="col-12">
                    ...
                    <div class="radio-row">
                        <label class="radio-pill"><input type="radio" name="hospitalized" value="1"
                                {{ old('hospitalized') === '1' ? 'checked' : '' }}> Yes</label>
                        <label class="radio-pill"><input type="radio" name="hospitalized" value="0"
                                {{ old('hospitalized') === '0' ? 'checked' : '' }}> No</label>
                    </div>
                    <div class="mt-2">
                        <textarea name="hospitalized_reason" rows="2" class="textareax"
                            placeholder="If yes, why?">{{ old('hospitalized_reason') }}</textarea>
                    </div>
                </div>
                ...
                <div class="col-12">
                    ...
                    <div class="radio-row">
                        <label class="radio-pill"><input type="radio" name="taking_medication" value="1"
                                {{ old('taking_medication') === '1' ? 'checked' : '' }}> Yes</label>
                        <label class="radio-pill"><input type="radio" name="taking_medication" value="0"
                                {{ old('taking_medication') === '0' ? 'checked' : '' }}> No</label>
                    </div>
                    <div class="mt-2">
                        <textarea name="medications" rows="2" class="textareax"
                            placeholder="If yes, list medications">{{ old('medications') }}</textarea>
                    </div>
                </div>
                ...
                <div class="col-12">
                    ...
                    <div class="radio-row">
                        <label class="radio-pill"><input type="radio" name="takes_aspirin" value="1"
                                {{ old('takes_aspirin') === '1' ? 'checked' : '' }}> Yes</label>
                        <label class="radio-pill"><input type="radio" name="takes_aspirin" value="0"
                                {{ old('takes_aspirin') === '0' ? 'checked' : '' }}> No</label>
                    </div>
                </div>
                ...
                <div class="col-12">
                    ...
                    <div class="mt-2">
                        <input type="text" name="allergies_other" id="allergies_other" class="inputx"
                            placeholder="Other allergy (optional)" value="{{ old('allergies_other') }}">
                    </div>
                </div>
                ...
                <div class="col-12 col-md-4">
                    ...
                    <div class="radio-row">
                        <label class="radio-pill"><input type="radio" name="tobacco_use" value="1"
                                {{ old('tobacco_use') === '1' ? 'checked' : '' }}> Yes</label>
                        <label class="radio-pill"><input type="radio" name="tobacco_use" value="0"
                                {{ old('tobacco_use') === '0' ? 'checked' : '' }}> No</label>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-4">
                    ...
                    <div class="radio-row">
                        <label class="radio-pill"><input type="radio" name="alcohol_use" value="1"
                                {{ old('alcohol_use') === '1' ? 'checked' : '' }}> Yes</label>
                        <label class="radio-pill"><input type="radio" name="alcohol_use" value="0"
                                {{ old('alcohol_use') === '0' ? 'checked' : '' }}> No</label>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-4">
                    ...
                    <div class="radio-row">
                        <label class="radio-pill"><input type="radio" name="dangerous_drugs" value="1"
                                {{ old('dangerous_drugs') === '1' ? 'checked' : '' }}> Yes</label>
                        <label class="radio-pill"><input type="radio" name="dangerous_drugs" value="0"
                                {{ old('dangerous_drugs') === '0' ? 'checked' : '' }}> No</label>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-8">
                    ...
                    <div class="row g-2">
                        <div class="col-12 col-md-4">
                            <div class="radio-row">
                                <label class="radio-pill"><input type="radio" name="pregnant" value="1"
                                        {{ old('pregnant') === '1' ? 'checked' : '' }}> Pregnant</label>
                                <label class="radio-pill"><input type="radio" name="pregnant" value="0"
                                        {{ old('pregnant') === '0' ? 'checked' : '' }}> No</label>
                            </div>
                        </div>
                        <div class="col-12 col-md-4">
                            <div class="radio-row">
                                <label class="radio-pill"><input type="radio" name="nursing" value="1"
                                        {{ old('nursing') === '1' ? 'checked' : '' }}> Nursing</label>
                                <label class="radio-pill"><input type="radio" name="nursing" value="0"
                                        {{ old('nursing') === '0' ? 'checked' : '' }}> No</label>
                            </div>
                        </div>
                        <div class="col-12 col-md-4">
                            <div class="radio-row">
                                <label class="radio-pill"><input type="radio" name="birth_control_pills" value="1"
                                        {{ old('birth_control_pills') === '1' ? 'checked' : '' }}> Birth control
                                    pills</label>
                                <label class="radio-pill"><input type="radio" name="birth_control_pills" value="0"
                                        {{ old('birth_control_pills') === '0' ? 'checked' : '' }}> No</label>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="card-bodyx">
            ...
            <div class="mt-2">
                <input type="text" name="medical_conditions_other" id="medical_conditions_other" class="inputx"
                    placeholder="Other condition (optional)" value="{{ old('medical_conditions_other') }}">
            </div>
        </div>
    </div>
