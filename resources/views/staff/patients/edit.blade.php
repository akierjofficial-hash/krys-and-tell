...
<form action="{{ route('staff.patients.update', $patient->id) }}" method="POST" id="patientEditForm" class="form-max">
        ...
        <div class="card-bodyx">
            <div class="row g-3">
                <div class="col-12 col-md-4">
                    ...
                    <input type="text" name="last_name" class="inputx" value="{{ old('last_name', $patient->last_name) }}" required>
                </div>

                <div class="col-12 col-md-4">
                    <label class="form-labelx">First Name <span class="text-danger">*</span></label>
                    <input type="text" name="first_name" class="inputx" value="{{ old('first_name', $patient->first_name) }}" required>
                </div>

                <div class="col-12 col-md-4">
                    <label class="form-labelx">Middle Name</label>
                    <input type="text" name="middle_name" class="inputx" value="{{ old('middle_name', $patient->middle_name) }}">
                </div>

                <div class="col-12 col-md-4">
                    <label class="form-labelx">Birthdate <span class="text-danger">*</span></label>
                    <input type="date" name="birthdate" class="inputx" value="{{ old('birthdate', $patient->birthdate) }}" required>
                </div>
                ...
                <div class="col-12 col-md-4">
                    ...
                    <input type="text" name="nickname" class="inputx" value="{{ old('nickname', $info?->nickname) }}" required>
                </div>

                <div class="col-12">
                    <label class="form-labelx">Home Address <span class="text-danger">*</span></label>
                    <textarea name="address" rows="2" class="textareax" required>{{ old('address', $patient->address) }}</textarea>
                </div>

                <div class="col-12 col-md-4">
                    <label class="form-labelx">Occupation <span class="text-danger">*</span></label>
                    <input type="text" name="occupation" class="inputx" value="{{ old('occupation', $info?->occupation) }}" required>
                </div>

                <div class="col-12 col-md-4">
                    <label class="form-labelx">Cell/Mobile No. <span class="text-danger">*</span></label>
                    <input type="text" name="contact_number" class="inputx" value="{{ old('contact_number', $patient->contact_number) }}" required>
                    <div class="helper">Example: 09XXXXXXXXX</div>
                </div>

                <div class="col-12 col-md-4">
                    <label class="form-labelx">Email Add <span class="text-danger">*</span></label>
                    <input type="email" name="email" class="inputx" value="{{ old('email', $patient->email) }}" required>
                </div>
                ...
                <div class="col-12 col-md-4">
                    ...
                    <input type="text" name="office_no" class="inputx" value="{{ old('office_no', $info?->office_no) }}">
                </div>
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input type="text" name="dental_insurance" class="inputx" value="{{ old('dental_insurance', $info?->dental_insurance) }}">
                </div>

                <div class="col-12 col-md-6">
                    <label class="form-labelx">Effective Date</label>
                    <input type="date" name="effective_date" class="inputx" value="{{ old('effective_date', optional($info?->effective_date)->format('Y-m-d')) }}">
                </div>
        ...
        <div class="card-bodyx">
            <div class="row g-3">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input type="text" name="guardian_name" id="guardian_name" class="inputx" value="{{ old('guardian_name', $info?->guardian_name) }}">
                </div>

                <div class="col-12 col-md-6">
                    <label class="form-labelx">Occupation <span class="text-danger" id="guardian_occ_star">*</span></label>
                    <input type="text" name="guardian_occupation" id="guardian_occupation" class="inputx" value="{{ old('guardian_occupation', $info?->guardian_occupation) }}">
                </div>

                <div class="col-12 col-md-6">
                    <label class="form-labelx">Whom may we thank for referring you?</label>
                    <input type="text" name="referral_source" class="inputx" value="{{ old('referral_source', $info?->referral_source) }}">
                </div>
        ...
        <div class="card-bodyx">
            <div class="row g-3">
                <div class="col-12 col-md-6">
                    ...
                    <input type="text" name="previous_dentist" class="inputx" value="{{ old('previous_dentist', $info?->previous_dentist) }}">
                </div>

                <div class="col-12 col-md-6">
                    <label class="form-labelx">Last Dental Visit</label>
                    <input type="date" name="last_dental_visit" class="inputx" value="{{ old('last_dental_visit', optional($info?->last_dental_visit)->format('Y-m-d')) }}">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card-bodyx">
            <div class="row g-3">
                <div class="col-12 col-md-6">
                    ...
                    <input type="text" name="physician_name" class="inputx" value="{{ old('physician_name', $info?->physician_name) }}">
                </div>

                <div class="col-12 col-md-6">
                    <label class="form-labelx">Specialty</label>
                    <input type="text" name="physician_specialty" class="inputx" value="{{ old('physician_specialty', $info?->physician_specialty) }}">
                </div>
                ...
                <div class="col-12">
                    ...
                    <div class="radio-row">
                        <label class="radio-pill"><input type="radio" name="good_health" value="1" {{ $gh === '1' ? 'checked' : '' }}> Yes</label>
                        <label class="radio-pill"><input type="radio" name="good_health" value="0" {{ $gh === '0' ? 'checked' : '' }}> No</label>
                    </div>
                </div>
                ...
                <div class="col-12">
                    ...
                    <div class="radio-row">
                        <label class="radio-pill"><input type="radio" name="under_treatment" value="1" {{ $ut === '1' ? 'checked' : '' }}> Yes</label>
                        <label class="radio-pill"><input type="radio" name="under_treatment" value="0" {{ $ut === '0' ? 'checked' : '' }}> No</label>
                    </div>
                    <div class="mt-2">
                        <input type="text" name="treatment_condition" class="inputx" placeholder="If yes, what condition?" value="{{ old('treatment_condition', $info?->treatment_condition) }}">
                    </div>
                </div>
                ...
                <div class="col-12">
                    ...
                    <div class="radio-row">
                        <label class="radio-pill"><input type="radio" name="serious_illness" value="1" {{ $si === '1' ? 'checked' : '' }}> Yes</label>
                        <label class="radio-pill"><input type="radio" name="serious_illness" value="0" {{ $si === '0' ? 'checked' : '' }}> No</label>
                    </div>
                    <div class="mt-2">
                        <textarea name="serious_illness_details" rows="2" class="textareax" placeholder="If yes, describe">{{ old('serious_illness_details', $info?->serious_illness_details) }}</textarea>
                    </div>
                </div>
                ...
                <div class="col-12">
                    ...
                    <div class="radio-row">
                        <label class="radio-pill"><input type="radio" name="hospitalized" value="1" {{ $hos === '1' ? 'checked' : '' }}> Yes</label>
                        <label class="radio-pill"><input type="radio" name="hospitalized" value="0" {{ $hos === '0' ? 'checked' : '' }}> No</label>
                    </div>
                    <div class="mt-2">
                        <textarea name="hospitalized_reason" rows="2" class="textareax" placeholder="If yes, why?">{{ old('hospitalized_reason', $info?->hospitalized_reason) }}</textarea>
                    </div>
                </div>
                ...
                <div class="col-12">
                    ...
                    <div class="radio-row">
                        <label class="radio-pill"><input type="radio" name="taking_medication" value="1" {{ $tm === '1' ? 'checked' : '' }}> Yes</label>
                        <label class="radio-pill"><input type="radio" name="taking_medication" value="0" {{ $tm === '0' ? 'checked' : '' }}> No</label>
                    </div>
                    <div class="mt-2">
                        <textarea name="medications" rows="2" class="textareax" placeholder="If yes, list">{{ old('medications', $info?->medications) }}</textarea>
                    </div>
                </div>
                ...
                <div class="col-12">
                    ...
                    <div class="radio-row">
                        <label class="radio-pill"><input type="radio" name="takes_aspirin" value="1" {{ $ta === '1' ? 'checked' : '' }}> Yes</label>
                        <label class="radio-pill"><input type="radio" name="takes_aspirin" value="0" {{ $ta === '0' ? 'checked' : '' }}> No</label>
                    </div>
                </div>
                ...
                <div class="col-12">
                    ...
                    <div class="mt-2">
                        <input type="text" name="allergies_other" class="inputx" placeholder="Other allergy (optional)" value="{{ old('allergies_other', $info?->allergies_other) }}">
                    </div>
                </div>
                ...
                <div class="col-12 col-md-4">
                    ...
                    <div class="radio-row">
                        <label class="radio-pill"><input type="radio" name="tobacco_use" value="1" {{ $tb === '1' ? 'checked' : '' }}> Yes</label>
                        <label class="radio-pill"><input type="radio" name="tobacco_use" value="0" {{ $tb === '0' ? 'checked' : '' }}> No</label>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-4">
                    ...
                    <div class="radio-row">
                        <label class="radio-pill"><input type="radio" name="alcohol_use" value="1" {{ $al === '1' ? 'checked' : '' }}> Yes</label>
                        <label class="radio-pill"><input type="radio" name="alcohol_use" value="0" {{ $al === '0' ? 'checked' : '' }}> No</label>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-4">
                    ...
                    <div class="radio-row">
                        <label class="radio-pill"><input type="radio" name="dangerous_drugs" value="1" {{ $dd === '1' ? 'checked' : '' }}> Yes</label>
                        <label class="radio-pill"><input type="radio" name="dangerous_drugs" value="0" {{ $dd === '0' ? 'checked' : '' }}> No</label>
                    </div>
                </div>

                <div class="col-12 col-md-4">
                    <label class="form-labelx">Bleeding Time</label>
                    <input type="text" name="bleeding_time" class="inputx" value="{{ old('bleeding_time', $info?->bleeding_time) }}">
                </div>

                <div class="col-12 col-md-4">
                    <label class="form-labelx">Blood Type</label>
                    <input type="text" name="blood_type" class="inputx" value="{{ old('blood_type', $info?->blood_type) }}">
                </div>

                <div class="col-12 col-md-4">
                    <label class="form-labelx">Blood Pressure</label>
                    <input type="text" name="blood_pressure" class="inputx" value="{{ old('blood_pressure', $info?->blood_pressure) }}">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card-shell">
        ...
        <div class="card-bodyx">
            ...
            <div class="mt-2">
                <input type="text" name="medical_conditions_other" class="inputx" placeholder="Other condition (optional)" value="{{ old('medical_conditions_other', $info?->medical_conditions_other) }}">
            </div>
        </div>
    </div>
    ...
    <div class="card-shell">
        ...
        <div class="card-bodyx">
            ...
            @if($info && $info->signature_path)
                ...
                <img class="sig-preview" src="{{ asset('storage/'.$info->signature_path) }}" alt="Current Patient Signature">
            @endif
        </div>
    </div>
    ...
    <div class="card-shell">
        <div class="card-head">
            ...
            <div class="hint">Initial each section + optionally re-sign</div>
        </div>
            ...
            <div class="row g-3">
                @foreach($consentSections as $key => $label)
                    <div class="col-12 col-md-8">
                        ...
                        <div class="helper">Type initials</div>
                    </div>
                    <div class="col-12 col-md-4">
                ...
                <div class="col-12"><hr style="border-color:rgba(15,23,42,.10);"></div>
