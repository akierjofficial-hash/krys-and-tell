...
.receipt-container{
    width: 100%;
    max-width: 7.6in; /* inside a Letter sheet with padding */
    margin: 0 auto;
    padding: 12mm 12mm;
...
.brand-title .clinic{ font-size: 18px; font-weight: 900; margin:0; }
...
/* ===== PRINT (this is the alignment fix) ===== */
@media print{
    html, body{
    ...
    *{
    ...
    /* take over the whole page so layout/sidebars don't shrink it */
    .receipt-page{
    ...
    .receipt-container{
        ...
        /* IMPORTANT: this controls how “full” it looks */
    ...
    /* footer sits nicely at the bottom */
