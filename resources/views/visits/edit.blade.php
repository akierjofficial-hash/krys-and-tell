...
<div class="col-md-6">
    ...
    <select name="doctor_id" class="selectx" required>
        ...
        @forelse($doctors as $doc)
            <option value="{{ $doc->id }}"
                @selected(old('doctor_id', $visit->doctor_id) == $doc->id)>
    ...
    <div class="helptext">
        This list is managed from Admin → Doctors. Only Active doctors appear here.
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" name="visit_date" class="inputx" value="{{ \Carbon\Carbon::parse($visit->visit_date)->format('Y-m-d') }}" required>
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="notes" rows="3" class="textareax" placeholder="Optional notes...">{{ $visit->notes }}</textarea>
                    </div>
