...
@php
    ...
    if ($user->last_login_at) {
        $lastLoginText = \Carbon\Carbon::parse($user->last_login_at)->format('M d, Y h:i A');
    }
@endphp
                    ...
                    <form method="POST" action="{{ route('admin.users.update', $user->id) }}">
                        ...
                        <div class="sec mb-3">
                            <div class="sec-title">
                                ...
                                <span class="mini">Update info</span>
                            </div>
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input
                                        ...
                                        required
                                    >
                                    <div class="hint">Displayed across admin & staff panels.</div>
                                </div>
                        ...
                        <div class="sec mb-3">
                            <div class="sec-title">
                                <span><i class="fa fa-shield-halved me-2"></i> Access</span>
                                <span class="mini">Role & status</span>
                            </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="strength">
                                        ...
                                        <div class="strength-label" id="pwLabel">No change</div>
                                    </div>
                        ...
                        <div class="sec">
                            ...
                            <div style="margin-top:12px; display:flex; justify-content:space-between; align-items:center; gap:10px;">
                                <span class="role-chip" id="pvRoleChip">
                                    ...
                                    <span id="pvRoleText">{{ old('role', $user->role) ?: 'staff' }}</span>
                                </span>

                                <span class="role-chip" id="pvStatusChip">
                                    <span class="role-dot" id="pvStatusDot" style="background: rgba(34,197,94,.95);"></span>
                                    <span id="pvStatusText">{{ old('is_active', $user->is_active) ? 'Active' : 'Inactive' }}</span>
                                </span>
                            </div>
                            ...
                            <div style="margin-top:12px;">
                                <div class="krow">
                                    ...
                                    <div class="kval" id="pvAccess">—</div>
                                </div>
                                <div class="krow">
                                    <div class="klabel">Password</div>
                                    <div class="kval" id="pvSecurity">No change</div>
                                </div>
                            </div>

                            <div class="hint" style="margin-top:12px;">
                                <i class="fa fa-circle-info me-1"></i>
                                Preview only — actual permissions follow middleware/roles.
                            </div>
                        </div>

                        <div class="sec mt-3">
                            <div class="sec-title" style="margin-bottom:10px;">
                                <span><i class="fa fa-clock me-2"></i> Last Login</span>
                                <span class="mini">Audit</span>
                            </div>

                            <div class="krow">
                                <div class="klabel">Date</div>
                                <div class="kval">{{ $lastLoginText }}</div>
                            </div>
                            <div class="krow">
                                <div class="klabel">IP</div>
                                <div class="kval">{{ $lastIp }}</div>
                            </div>
                            <div class="krow">
                                <div class="klabel">User ID</div>
                                <div class="kval">#{{ $user->id }}</div>
                            </div>
                        </div>
...
(function(){
    ...
    const pvStatusDot  = document.getElementById('pvStatusDot');
    ...
    function setStatusUI(){
        const active = !!activeBox?.checked;
        pvStatusText.textContent = active ? 'Active' : 'Inactive';
        pvStatusDot.style.background = active ? 'rgba(34,197,94,.95)' : 'rgba(148,163,184,.85)';
    }
    ...
    function applyStrength(){
        ...
        if (!pw){
            ...
            pwFill.style.background = 'rgba(148,163,184,.55)';
            pwLabel.textContent = 'No change';
            pvSecurity.textContent = 'No change';
            return;
        }
