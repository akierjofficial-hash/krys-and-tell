...
<style>
    ...
    .btn-warnx{
        ...
        box-shadow: 0 10px 18px rgba(217,119,6,.18);
        transition: .15s ease;
        white-space: nowrap;
    }
    .btn-warnx:hover{
        transform: translateY(-1px);
        box-shadow: 0 14px 24px rgba(217,119,6,.24);
        color:#fff;
    }
                ...
                <div class="col-12 col-md-6">
                    ...
                    <select name="patient_id" class="selectx" required>
                        @foreach($patients as $patient)
                            <option value="{{ $patient->id }}" @selected($appointment->patient_id == $patient->id)>
...
<div class="col-12 col-md-6">
    ...
    <select name="dentist_name" class="selectx" required>
        ...
        @forelse($doctors as $doc)
            <option
                value="{{ $doc->name }}"
                @selected(old('dentist_name', $appointment->dentist_name) == $doc->name)
            >
    ...
    <div class="helper">
        This list is managed from Admin → Doctors. Only Active doctors appear here.
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input type="date" name="appointment_date" value="{{ $appointment->appointment_date }}" class="inputx" required>
                </div>

                <!-- Time -->
                <div class="col-12 col-md-6">
                    <label class="form-labelx">Appointment Time <span class="text-danger">*</span></label>
                    <input type="time" name="appointment_time" value="{{ $appointment->appointment_time }}" class="inputx" required step="300">
                ...
                <div class="col-12">
                    ...
                    <textarea name="notes" class="textareax">{{ $appointment->notes }}</textarea>
                </div>
